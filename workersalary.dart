...
const String _baseURL = 'localhost';
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'success') {
          final salary = WorkerSalary(
            data['data']['worker_name'],
            data['data']['usd_per_day'],
            data['data']['workshops_count'],
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.network(
              'https://www.kourany.com/img/footer-man.png', // Example logo image
              height: 150,
            ),
            const SizedBox(height: 20),
